...
from widgets.round_button import RoundButton   # ← مهم
...
class ArticlePage(Screen):
    def __init__(self, **kwargs):
        ...
        items = [
            ("Images/nano.jpg", "nano", "ایران قوی در فناوری نانو"),
            ("Images/hasteyi.jpg", "page2", "ایران قوی در فناوری هسته ای"),
            ("Images/moshaki.jpg", "page3", "ایران قوی در سلاح موشکی"),
            ("Images/energy.jpg", "page4", "ایران قوی در انرژی های پاک"),
        ]
