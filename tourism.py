...
class MainLayout(FloatLayout):
    def __init__(self, **kwargs):
        ...
        self.top_image = Image(
            source="Images/banner.jpg",   # مسیر عکس را اینجا قرار بده
            size_hint=(0.7, 0.35), # اندازه نسبی
            pos_hint={"center_x": 0.5, "top": 1}, # بالای وسط صفحه
            allow_stretch=True,
            keep_ratio=True
        )
        ...
        self.add_widget(Label(
            text=fa("لطفاً استان، شهر و نوع مکان سفر را انتخاب کنید"),
            font_name="Far_Nazanin",
            font_size=20,
            color=(0.2, 0.2, 0.2, 1),
            size_hint=(0.92, 0.08),
        ...
        self._style_button(self.prov_spinner, (0.1, 0.7, 0.1, 1))
        ...
        self._style_button(self.city_spinner, (1.0, 1.0, 1.0, 1.0))
        self.city_map = {}
        ...
        self._style_button(self.type_spinner, (0.9, 0.15, 0.15, 1.0))
    ...
    # سایه نوک‌تیز در سمت راست و پایین
    def _style_button(self, widget, color):
        with widget.canvas.before:
            ...
            Color(0, 0, 0, 0.28)
            widget.shadow = Rectangle(
                pos=(widget.x + 10, widget.y - 10),
                size=widget.size
            )
    ...
    def _update_styles(self, widget, *args):
        if hasattr(widget, 'bg'):
            ...
            widget.shadow.pos = (widget.x + 10, widget.y - 10)
    ...
    def on_type(self, spinner, value):
        ...
        if prov and city and typ:
            ...
            self.result.text = "\n \n" + fa(place) if place else fa("مکانی یافت نشد")
        else:
            self.result.text = '\n' + fa("همه گزینه‌ها را انتخاب کنید")


class tourismpage(Screen):
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
